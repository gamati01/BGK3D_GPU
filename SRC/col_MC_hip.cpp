...
//  col_MC_hip.cpp
//
//  HIP back-end for the native GPU port of the fused collision kernel.
//  Compiled with hipcc and -DUSE_HIP.  The actual kernel + launch logic
//  lives in the shared header col_MC_gpu.hpp so the CUDA back-end
//  (col_MC_cuda.cu) can reuse it verbatim.
//
...
extern "C" void col_mc_gpu(
    // inputs a01..a19 (device pointers)
    ...
    // outputs b01..b18 (device pointers); direction 19 is written into a19
    ...
    // dimensions and scalar parameters (by value)
